<template>
  <div>
    <div style="height:111px;background: #96B97D;border:1px #96B97D solid;">
      <h1 style="line-height: 70px;margin-left: 30px;text-shadow: 0 0 2px black;color: white;">ZFQ'IDE</h1>
    </div>
    ...
    <el-container>
      ...
      <el-card class="box-card">
        <div style="height:50px;">
          <el-button style="float:left;margin-right: -10px;" @click = "clickInput" v-if="isInput" type="primary"> input:</el-button>
          <el-button style="float:left;margin-right: -10px;" @click = "clickInput" v-else> input:</el-button>
          <el-button style="float:left" @click = "clickOutput" v-if="isInput">output:</el-button>
          <el-button style="float:left;margin-right: -10px;" @click = "clickInput" v-else type="primary">output:</el-button>
        </div>
        <Editor ref = "output"/>
      </el-card>
    </el-container>
